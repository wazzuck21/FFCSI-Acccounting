...
export const DEFAULT_BILLING_TEMPLATE_CONFIG: BillingTemplateConfig = {
  ...
  marginMm: 14,
  firmName: 'AFMS & CO. CERTIFIED PUBLIC ACCOUNTANTS',
  firmSubtitle: 'Tax Advisory, Audit & Accounting Services',
  firmAddress: 'Suite 1400, Ortigas Financial Center, Pasig City',
  firmTIN: 'VAT Reg. TIN 008-112-445-000',
  accentColor: '#047857', // Emerald 700
  logoUrl: '',
  showLogo: false,
  showRemittanceBox: true,
  remittanceText: 'Please settle checks payable to AFMS & CO. CPAs or transfer via Bank Deposit / Online Transfer.',
