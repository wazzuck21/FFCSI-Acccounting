          ...
          <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 shadow-2xl text-slate-900 space-y-4 text-xs animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto my-auto">
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-bold text-base text-slate-900">Payment Tagging & Verification</h3>
                  <p className="text-xs text-slate-500 flex flex-wrap items-center gap-1.5 mt-0.5">
                    <span>{selectedPayable.clientName}</span>
                    <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-amber-50 border border-amber-200 text-amber-900 font-mono font-bold text-[11px]">
                      {selectedPayable.itemName} • {selectedPayable.month}
                    </span>
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleVerifyPaymentSubmit} className="space-y-3.5">
              <div>
                <label className="block text-slate-600 mb-1 font-bold text-[11px]">Date Payment Made *</label>
                <input
                  type="date"
                  required
                  value={paidDate}
                  onChange={e => setPaidDate(e.target.value)}
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-200 focus:border-amber-400"
                />
              </div>

              <div>
                <label className="block text-slate-600 mb-1 font-bold text-[11px]">Payment Method *</label>
                <select
                  value={paymentMethod}
                  onChange={e => setPaymentMethod(e.target.value as any)}
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-200 focus:border-amber-400 font-semibold"
                >
              ...
              {paymentMethod === 'Bank' && (
                <div>
                  <label className="block text-slate-600 mb-1 font-bold text-[11px]">Select Bank *</label>
                  <select
                    value={bankName}
              ...
              <div>
                <label className="block text-slate-600 mb-1 font-bold text-[11px]">Reference / OR Number</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <CurrencyInput
                  ...
                  className="w-full bg-amber-50/70 border border-amber-300 rounded-xl text-amber-950 font-mono font-bold text-sm px-3.5 py-2 focus:bg-white focus:ring-2 focus:ring-amber-300"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl shadow-2xs flex items-center gap-1.5 cursor-pointer transition-colors"
                >
          ...
          <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 shadow-2xl text-slate-900 space-y-4 text-xs animate-in fade-in zoom-in-95 duration-150 max-h-[90vh] overflow-y-auto my-auto">
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-bold text-base text-slate-900">Modify Payment Tag Details</h3>
                  <p className="text-xs text-slate-500 flex flex-wrap items-center gap-1.5 mt-0.5">
                    <span>{modifyPayable.clientName}</span>
                    <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-blue-50 border border-blue-200 text-blue-900 font-mono font-bold text-[11px]">
                      {modifyPayable.itemName} • {modifyPayable.month}
                    </span>
                  </p>
                </div>
              </div>
            ...
            <form onSubmit={handleSaveModificationSubmit} className="space-y-3.5">
              <div>
                <label className="block text-slate-600 mb-1 font-bold text-[11px]">Date Payment Made *</label>
                <input
                  type="date"
                  ...
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:bg-white focus:ring-2 focus:ring-blue-200 focus:border-blue-400"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:bg-white focus:ring-2 focus:ring-blue-200 focus:border-blue-400 font-semibold"
                >
                  <option value="Bank">Bank Deposit / Transfer</option>
                  <option value="Maya">Maya E-Wallet</option>
                  <option value="GCash">GCash E-Wallet</option>
              ...
              <div>
                ...
                <CurrencyInput
                  ...
                  className="w-full bg-blue-50/50 border border-blue-200 rounded-xl text-blue-900 font-mono font-bold text-sm px-3.5 py-2 focus:bg-white focus:ring-2 focus:ring-blue-200"
                />
              </div>

              <div>
                <label className="block text-slate-600 mb-1 font-bold text-[11px]">Reason for Modification / Notes</label>
                <input
                  type="text"
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                <button
                  ...
                  className="px-3.5 py-2 bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 rounded-xl font-bold text-xs flex items-center gap-1 cursor-pointer transition-colors"
                >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-2xs flex items-center gap-1.5 cursor-pointer transition-colors"
                  >
