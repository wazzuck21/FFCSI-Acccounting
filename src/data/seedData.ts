...
export const INITIAL_CLIENTS: ClientProfile[] = [
  {
    ...
    birAssignedStaffIds: ['user_accounting_1', 'user_staff_1'],
    birAssignedStaffNames: ['Juan dela Cruz', 'Mark Anthony V.'],
    benefitsAssignedStaffIds: ['user_benefits_1', 'user_billing_1'],
    benefitsAssignedStaffNames: ['Atty. Roberto Cruz', 'Clarissa Reyes'],
    retainersFee: 45000,
  ...
  },
  {
    ...
    assignedStaffId: 'user_staff_1',
    assignedStaffName: 'Juan dela Cruz',
    birAssignedStaffIds: ['user_accounting_1'],
    birAssignedStaffNames: ['Juan dela Cruz'],
    benefitsAssignedStaffIds: ['user_benefits_1'],
    benefitsAssignedStaffNames: ['Atty. Roberto Cruz'],
    retainersFee: 20000,
  ...
  },
  {
    ...
    assignedStaffId: 'user_billing_1',
    assignedStaffName: 'Clarissa Reyes',
    birAssignedStaffIds: ['user_billing_1', 'user_staff_1'],
    birAssignedStaffNames: ['Clarissa Reyes', 'Mark Anthony V.'],
    benefitsAssignedStaffIds: ['user_benefits_1'],
    benefitsAssignedStaffNames: ['Atty. Roberto Cruz'],
    retainersFee: 32000,
